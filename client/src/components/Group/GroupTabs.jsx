...
<button
  className="btn btn-circle bg-blue-500 hover:bg-blue-400 text-white shadow-lg hover:shadow-xl transition-all duration-200"
          ...
          <div>
            <div className="flex justify-between items-center mb-4">
              ...
              <button
                ...
                className={`btn ${showUploader ? 'btn-error' : 'btn-secondary'}`}
              >
